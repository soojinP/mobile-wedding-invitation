    ...
    <div>
      ...
      <div className="cal-grid">
        ...
        {cells.map((day, i) => {
          ...
          return (
            <div key={day} className={`cal-cell ${isToday ? 'selected' : ''} ${isSun || isHoliday ? 'holiday' : ''} ${isSat ? 'sat' : ''}`}>
      ...
      <div className="cal-event">
        ...
        <div className="cal-event-content">
          ...
          <div className="cal-event-note">대체공휴일 (광복절)</div>
        </div>
      </div>
      ...
      <div className="cal-event secondary">
        ...
        <div className="cal-event-content">
          ...
          <div className="cal-event-title" style={{ color: '#34c759' }}>대체공휴일</div>
